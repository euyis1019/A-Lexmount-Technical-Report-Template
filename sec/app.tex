...
\input{table/Generalization of rubric-guided evaluation}
\input{table/Generalization of rubric-guided evaluation2}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=1\columnwidth]{fig/caset21.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=1\columnwidth]{fig/caset22.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=1\columnwidth]{fig/caset23.pdf}
