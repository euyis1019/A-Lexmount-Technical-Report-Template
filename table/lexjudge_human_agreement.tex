% === LexJudge Human Agreement Table (half-width, text-wrapped) ===
% NOTE: wraptable is non-floating — it stays where it is placed and the
% following paragraph(s) wrap around it. Keep this \input directly before
% the paragraph that should flow alongside the table.
